...
// const consumer_secret = config.oauth.consumer_secret;
...
// const authorizeURL: any = new Date('https://api.twitter.com/oauth/authorize')
...
//     hash_function: (baseString: any, key: any) => crypto.createHmac('sha1', key).update(baseString).digest('base64')
// });

// export default async function input(prompt: any) {
